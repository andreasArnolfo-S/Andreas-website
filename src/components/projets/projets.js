...
const Projets = () => {
  ...
  return (
    <>
      <svg className='-mt-72' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 250"><path fill="#191d24" fill-opacity="1" d="M0,192L720,192L1440,32L1440,320L720,320L0,320Z"></path></svg>
      <div className="projets">
        <Fade direction='left'>
          <h1 className='myFont text-6xl text-center'>Mes realisations</h1>
        </Fade>
        <div className='flex flex-row-reverse flex-wrap p-5 gap-5 w-full justify-center mt-10'>
          <Fade direction='right' cascade>
            {projets.map((projet, index) => (
              <Card data={projet} key={index} />
            ))}
          </Fade>
        </div>
      </div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 40 1440 320"><path fill="#191d24" fill-opacity="1" d="M0,224L288,256L576,64L864,64L1152,256L1440,96L1440,0L1152,0L864,0L576,0L288,0L0,0Z"></path></svg>
    </>
  );
}
